  ...
  if (orders.length === 0) {
    return (
      <div className="mt-6 rounded-md bg-cream-deep p-6 text-sm">
        ...
        <Link
          href="/products"
          className="mt-4 inline-flex items-center justify-center bg-burgundy text-cream px-6 py-3 text-xs uppercase tracking-[0.22em] hover:bg-burgundy-deep transition-colors"
        >
