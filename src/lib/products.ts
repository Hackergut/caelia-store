...
export const products: Product[] = [
  {
    ...
    images: [
      { src: "/products/new-beauty-case-burgundy-front.jpg", alt: "Beauty Mirror Case Burgundy Caelia" },
      { src: "/products/new-beauty-case-burgundy-open.jpg", alt: "Burgundy Caelia specchio e tasca" },
      { src: "/products/new-beauty-case-burgundy-logo.jpg", alt: "Logo CAELIA in rilievo Burgundy" },
      { src: "/products/new-beauty-case-burgundy-texture.jpg", alt: "Texture Burgundy Caelia" },
      { src: "/products/new-beauty-case-burgundy-pocket.jpg", alt: "Tasca Burgundy Caelia" },
      { src: "/products/new-beauty-case-burgundy-set.jpg", alt: "Set Burgundy Caelia" },
      { src: "/products/new-beauty-case-cacao-front.jpg", alt: "Beauty Mirror Case Cacao Caelia" },
      { src: "/products/new-beauty-case-cacao-open.jpg", alt: "Cacao Caelia specchio e tasca" },
      { src: "/products/new-beauty-case-cacao-logo.jpg", alt: "Logo CAELIA in rilievo Cacao" },
      { src: "/products/new-beauty-case-cacao-angle.jpg", alt: "Cacao Caelia tre quarti" },
      { src: "/products/new-beauty-case-crema-front.jpg", alt: "Beauty Mirror Case Crema Caelia" },
      { src: "/products/new-beauty-case-crema-open.jpg", alt: "Crema Caelia specchio e tasca" },
      { src: "/products/new-beauty-case-crema-logo.jpg", alt: "Logo CAELIA in rilievo Crema" },
  ...
  },
  {
    ...
    images: [
      { src: "/products/new-beauty-case-burgundy-logo.jpg", alt: "Beauty Mirror Case Mini Burgundy Caelia" },
      { src: "/products/new-beauty-case-cacao-logo.jpg", alt: "Beauty Mirror Case Mini Cacao Caelia" },
      { src: "/products/new-beauty-case-crema-logo.jpg", alt: "Beauty Mirror Case Mini Crema Caelia" },
      { src: "/products/new-beauty-case-crema-angle.jpg", alt: "Beauty Mirror Case Mini Crema Caelia tre quarti" },
    ],
    variants: [
      {
